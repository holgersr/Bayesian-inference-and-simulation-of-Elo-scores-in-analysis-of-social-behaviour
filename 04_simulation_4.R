...
cols <- viridis(n = 10, option = "A", alpha = 0.5, begin = 0, end = 0.8)

set.seed(1604)
starting_scores1 <- seq(-6, 6, length = 10) 
starting_scores2a <- sample(starting_scores1[-c(9, 10)])  
starting_scores2b <- sample(starting_scores1[-c(9, 10)])  
starting_scores2c <- sample(starting_scores1[-c(9, 10)])  
starting_scores2d <- sample(starting_scores1[-c(9, 10)])  
starting_scores2e <- sample(starting_scores1[-c(9, 10)])  
starting_scores2f <- sample(starting_scores1[-c(9, 10)])  
starting_scores2g <- sample(starting_scores1[-c(9, 10)])  
starting_scores2h <- sample(starting_scores1[-c(9, 10)])  
starting_scores2i <- sample(starting_scores1[-c(9, 10)])  
starting_scores2j <- sample(starting_scores1[-c(9, 10)])  
starting_scores3 <- starting_scores1[-c(9, 10)]  
...
pdf("simulation4.pdf", height = 5, width = 7)
...
for(rep_index in 1:repeats){
  ...
  plot(elo_sim[, 1], type = "n", ylim = range(c(elo_sim, starting_scores1, starting_scores3)), bty = "n", yaxt = "n", 
       xlab = "Interaction index", ylab = "Elo score")
  axis(2, lab = FALSE, at = seq(-5, 5, by = 5))
  mtext(side = 2, at = seq(-5, 5, by = 5), text = seq(-5, 5, by = 5), cex = 1, line = 0.7, las = 2)
  lty_period1 <- rep(1, 10)
  lty_period2 <- c(rep(1, 8), 0, 0)
  points(rep(1, 10), starting_scores1, col = cols, pch = 16)
  points(rep(1050, 8), starting_scores2a, col = cols, pch = 16)
  points(rep(1150, 8), starting_scores2b, col = cols, pch = 16)
  points(rep(1250, 8), starting_scores2c, col = cols, pch = 16)
  points(rep(1350, 8), starting_scores2d, col = cols, pch = 16)
  points(rep(1450, 8), starting_scores2e, col = cols, pch = 16)
  points(rep(1550, 8), starting_scores2f, col = cols, pch = 16)
  points(rep(1650, 8), starting_scores2g, col = cols, pch = 16)
  points(rep(1750, 8), starting_scores2h, col = cols, pch = 16)
  points(rep(1850, 8), starting_scores2i, col = cols, pch = 16)
  points(rep(1950, 8), starting_scores2j, col = cols, pch = 16)
  points(rep(4000, 8), starting_scores3, col = cols, pch = 16)
  ...
  elo_2nd_period <- est_hierarchy <- error <- error_corrected_for_sd <- elo_sim[1:4000, 1:8]
  ## 1:
  truth <- order(starting_scores1[1:8])
  for(i in 1:1000){
  ...
  plot(1:4000, sum_abs_error/length(truth), type = "s", bty = "n", xlab = "Interaction index", ylab = "Ranks MAE", yaxt = "n", lwd = 1)
  axis(2, las = 2)
