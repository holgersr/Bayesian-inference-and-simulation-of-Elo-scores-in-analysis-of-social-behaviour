...
## Plot results:
pdf("simulation1.pdf", height = 5, width = 8)
...
for(i in 1:length(n_interaction)){
  ...
  plot(bayes_starting_scores[[i]], starting_scores, pch = 16, bty = "n", 
       yaxt = "n", xlab = "Estimated starting scores", ylab = "True starting scores", 
...
for(i in 1:length(n_interaction)){
  ...
  plot(bayes_starting_scores[[i]], starting_scores, pch = 16, bty = "n", yaxt = "n", 
       xlab = "Estimated starting scores", ylab = "True starting scores", 
       xlim = plotting_range, ylim = plotting_range, 
  ...
  legend("bottomright", pch  = 16, col = rev(cols), legend = c("ML", "Bayes"), bty = "n")
}
dev.off()